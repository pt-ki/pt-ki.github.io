...
Where `YEAR` is a four-digit number, `MONTH` and `DAY` are
both two-digit numbers, and `MARKUP` is the file extension representing
...
on how to get the most out of Jekyll. File all bugs/feature requests
